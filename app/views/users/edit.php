    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4><i class="fas fa-user-edit me-2"></i>Edit User: <?php echo $data['user']['username']; ?></h4>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?php echo APP_URL; ?>/users/edit/<?php echo $data['user']['id']; ?>">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-3">
                                <h5 class="border-bottom pb-2 mb-3">Change Password (Optional)</h5>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="role" class="form-control" required>
                                    ...
                                    <option value="dispatcher" <?php echo $data['user']['role'] === 'dispatcher' ? 'selected' : ''; ?>>Dispatcher</option>
                                    <option value="driver" <?php echo $data['user']['role'] === 'driver' ? 'selected' : ''; ?>>Driver</option>
                                    <option value="mechanic" <?php echo $data['user']['role'] === 'mechanic' ? 'selected' : ''; ?>>Mechanic</option>
                                    <option value="accountant" <?php echo $data['user']['role'] === 'accountant' ? 'selected' : ''; ?>>Accountant</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="suspended" <?php echo $data['user']['status'] === 'suspended' ? 'selected' : ''; ?>>Suspended</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="address" class="form-control" value="<?php echo $data['user']['address'] ?? ''; ?>">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label class="form-label">City</label>
                                <input type="text" name="city" class="form-control" value="<?php echo $data['user']['city'] ?? ''; ?>">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label class="form-label">Postal Code</label>
                                <input type="text" name="postal_code" class="form-control" value="<?php echo $data['user']['postal_code'] ?? ''; ?>">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label class="form-label">Country</label>
                                <input type="text" name="country" class="form-control" value="<?php echo $data['user']['country'] ?? 'Tunisia'; ?>">
                            </div>
                        </div>
